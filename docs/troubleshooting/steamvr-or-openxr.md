...
- If you have a Pico headset with SteamVR, due to [known issues](../compatibility/hardware.md) in Pico's SteamVR drivers, you may need to use alternatives to SteamVR, such as Steam Link or Virtual Desktop
