...
All supported messages start with `com.fredemmott.openkneeboard/`, which I've left out for readability; for example, "RemoteUserAction" is `com.fredemmott.openkneeboard/RemoteUserAction".
